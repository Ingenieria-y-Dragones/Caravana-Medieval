...
public class CaravanaDTO {
    ...
    public CaravanaDTO(Long id, String nombre, Float velocidad, Float capacidadMaximaCarga, Float dinero, Integer puntosVida, Boolean tieneGuardias, Float tiempoTranscurrido) {
        this.id = id;
        this.nombre = nombre;
